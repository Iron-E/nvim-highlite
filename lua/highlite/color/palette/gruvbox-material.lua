...
local function get(bg, get_terminal)
	...
	if bg ~= "light" then
		...
		palette = {
			...
			diff_delete = 0x402120,
			diff_syntax_add = 0xA9B665,
			diff_syntax_change = 0x7DAEA3,
			diff_syntax_delete = 0xEA6962,
			enum = 0xD8A657,
			error = 0xEA6962,
			event = 0xEA6962,
			field = 0x7DAEA3,
			...
			keyword_modifier = 0xEA6962,
			keyword_operator = 0xE78A4E,
			keyword_return = 0xEA6962,
			keyword_type = 0xEA6962,
			label = 0xE78A4E,
			loop = 0xEA6962,
			macro = 0x89B482,
			markup_link_label = 0xD8A657,
			markup_list = 0x7DAEA3,
			markup_list_checked = 0xA9B665,
			markup_list_unchecked = 0x928374,
			markup_quote = 0x928374,
			message = 0xD4BE98,
			method = 0xA9B665,
			namespace = 0xD8A657,
			namespace_builtin = 0xD8A657,
			number = 0xD3869B,
			ok = 0xA9B665,
			operator = 0xE78A4E,
			parameter = 0xD4BE98,
			parameter_builtin = 0xD4BE98,
			preproc = 0xD3869B,
			...
			storage = 0xE78A4E,
			string = 0x89B482,
			string_documentation = 0x89B482,
			string_escape = 0xA9B665,
			string_regex = 0xA9B665,
			string_special = 0xD8A657,
			string_special_symbol = 0xD4BE98,
			structure = 0xE78A4E,
			syntax_error = 0xEA6962,
			tag = 0xE78A4E,
		...
		palette = {
			...
			diff_delete = 0xF9E0BB,
			diff_syntax_add = 0x6C782E,
			diff_syntax_change = 0x45707A,
			diff_syntax_delete = 0xC14A4A,
			enum = 0xB47109,
			error = 0xC14A4A,
			event = 0xC14A4A,
			field = 0x45707A,
			...
			keyword_modifier = 0xC14A4A,
			keyword_operator = 0xC35E0A,
			keyword_return = 0xC14A4A,
			keyword_type = 0xC14A4A,
			label = 0xC35E0A,
			loop = 0xC14A4A,
			macro = 0x4C7A5D,
			markup_link_label = 0xB47109,
			markup_list = 0x45707A,
			markup_list_checked = 0x6C782E,
			markup_list_unchecked = 0x928374,
			markup_quote = 0x928374,
			message = 0x654735,
			method = 0x6C782E,
			namespace = 0xB47109,
			namespace_builtin = 0xB47109,
			number = 0x945E80,
			ok = 0x6C782E,
			operator = 0xC35E0A,
			parameter = 0x654735,
			parameter_builtin = 0x654735,
			preproc = 0x945E80,
			...
			storage = 0xC35E0A,
			string = 0x4C7A5D,
			string_documentation = 0x4C7A5D,
			string_escape = 0x6C782E,
			string_regex = 0x6C782E,
			string_special = 0xB47109,
			string_special_symbol = 0x654735,
			structure = 0xC35E0A,
			syntax_error = 0xC14A4A,
			tag = 0xC35E0A,
