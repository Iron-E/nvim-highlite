...
fish_color_redirection ${@keyword.storage.fg | StorageClass.fg | @keyword.modifier.mutability.fg} ${@keyword.storage.bg | StorageClass.bg | @keyword.modifier.mutability.bg} ${@keyword.storage.bold | StorageClass.bold | @keyword.modifier.mutability.bold} ${@keyword.storage.italic | StorageClass.italic | @keyword.modifier.mutability.italic} ${@keyword.storage.underline | StorageClass.underline | @keyword.modifier.mutability.underline}
...
local FMT_OPTS = {
	...
	map = {
		bg = function(v)
			return " --background " .. tostring(v):sub(3)
		end,
		fg = function(v)
			return tostring(v):sub(3)
		end,
		bold = function()
			return " --bold"
		end,
