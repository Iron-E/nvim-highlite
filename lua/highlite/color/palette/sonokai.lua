...
local function get(bg, get_terminal)
	...
	if bg ~= "light" then
		...
		palette = {
			...
			diff_delete = 0x55393D,
			diff_syntax_add = 0x9ED072,
			diff_syntax_change = 0x76CCE0,
			diff_syntax_delete = 0xFC5D7C,
			enum = 0x76CCE0,
			error = 0xFC5D7C,
			event = 0xFC5D7C,
			field = 0xF39660,
			...
			keyword_modifier = 0xFC5D7C,
			keyword_operator = 0xFC5D7C,
			keyword_return = 0xFC5D7C,
			keyword_type = 0xFC5D7C,
			label = 0xFC5D7C,
			loop = 0xFC5D7C,
			macro = 0xB39DF3,
			markup_link_label = 0xB39DF3,
			markup_list = 0xE7C664,
			markup_list_checked = 0x9ED072,
			markup_list_unchecked = 0x7F8490,
			markup_quote = 0x7F8490,
			message = 0xE2E2E3,
			method = 0x9ED072,
			namespace = 0x76CCE0,
			namespace_builtin = 0xB39DF3,
			number = 0xB39DF3,
			ok = 0x9ED072,
			operator = 0xFC5D7C,
			parameter = 0xE2E2E3,
			parameter_builtin = 0xE2E2E3,
			preproc = 0xFC5D7C,
			...
			text_environment = 0xB39DF3,
			text_environment_name = 0x76CCE0,
