...
local function from_palette(palette, opts)
	...
	if any_syntax then
		...
		if all_syntax or syntax.vimscript ~= false then
			groups.vimCmdSep = 'Delimiter'
			groups.vimFunction = 'Function'
			groups.vimFgBgAttrib = 'Constant'
			groups.vimHiCterm = 'Label'
			groups.vimHiCtermFgBg = 'vimHiCterm'
			groups.vimHiGroup = 'Typedef'
			groups.vimHiGui = 'vimHiCterm'
			groups.vimHiGuiFgBg = 'vimHiGui'
			groups.vimHiKeyList = 'Operator'
			groups.vimIsCommand = 'Identifier'
			groups.vimOption = 'Keyword'
			groups.vimScriptDelim = 'Ignore'
			groups.vimSet = 'String'
			groups.vimSetEqual = 'Operator'
			groups.vimSetSep = 'Delimiter'
			groups.vimUserFunc = 'vimFunction'
		end
