...
local function fmt_terminal()
	return "\n\n\tg.terminal_color_0 = "
		.. vim.inspect(vim.g.terminal_color_0)
		.. "\n\tg.terminal_color_1 = "
		.. vim.inspect(vim.g.terminal_color_1)
		.. "\n\tg.terminal_color_2 = "
		.. vim.inspect(vim.g.terminal_color_2)
		.. "\n\tg.terminal_color_3 = "
		.. vim.inspect(vim.g.terminal_color_3)
		.. "\n\tg.terminal_color_4 = "
		.. vim.inspect(vim.g.terminal_color_4)
		.. "\n\tg.terminal_color_5 = "
		.. vim.inspect(vim.g.terminal_color_5)
		.. "\n\tg.terminal_color_6 = "
		.. vim.inspect(vim.g.terminal_color_6)
		.. "\n\tg.terminal_color_7 = "
		.. vim.inspect(vim.g.terminal_color_7)
		.. "\n\tg.terminal_color_8 = "
		.. vim.inspect(vim.g.terminal_color_8)
		.. "\n\tg.terminal_color_9 = "
		.. vim.inspect(vim.g.terminal_color_9)
		.. "\n\tg.terminal_color_10 = "
		.. vim.inspect(vim.g.terminal_color_10)
		.. "\n\tg.terminal_color_11 = "
		.. vim.inspect(vim.g.terminal_color_11)
		.. "\n\tg.terminal_color_12 = "
		.. vim.inspect(vim.g.terminal_color_12)
		.. "\n\tg.terminal_color_13 = "
		.. vim.inspect(vim.g.terminal_color_13)
		.. "\n\tg.terminal_color_14 = "
		.. vim.inspect(vim.g.terminal_color_14)
		.. "\n\tg.terminal_color_15 = "
		.. vim.inspect(vim.g.terminal_color_15)
end
