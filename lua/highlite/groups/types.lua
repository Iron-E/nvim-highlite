...
--- @alias highlite.groups.from_palette.opts.plugins.nvim 'aerial'|'barbar'|'cmp'|'flash'|'fzf'|'gitsigns'|'indent_blankline'|'lazy'|'leap'|'lsp_signature'|'lspconfig'|'lspsaga'|'mini'|'neotest'|'nvim_tree'|'packer'|'sniprun'|'symbols_outline'|'telescope'|'todo_comments'|'treesitter_context'|'trouble'
