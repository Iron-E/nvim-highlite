	...
	for group, definition in vim.spairs(vim.api.nvim_get_hl(0, {})) do
		if not filter(group, Native.default_hl_group_filter) then
			if definition.link then
				...
				local cterm = attr(definition.cterm, "bold")
				...
				local gui = attr(definition, "bold")
				...
				s = s
					...
					.. group
					.. " blend="
					.. (definition.blend or NONE)
					.. " cterm="
					.. (#cterm < 1 and NONE or cterm)
					.. " ctermbg="
					.. (definition.ctermbg or NONE)
					.. " ctermfg="
					.. (definition.ctermfg or NONE)
					.. " gui="
					.. (#gui < 1 and NONE or gui)
					.. " guibg="
					.. hex(definition.bg)
					.. " guifg="
					.. hex(definition.fg)
...
local function fmt_terminal()
	return "\n\n\tlet g:terminal_color_0 = "
		.. nil_to_null(vim.g.terminal_color_0)
		.. "\n\tlet g:terminal_color_1 = "
		.. nil_to_null(vim.g.terminal_color_1)
		.. "\n\tlet g:terminal_color_2 = "
		.. nil_to_null(vim.g.terminal_color_2)
		.. "\n\tlet g:terminal_color_3 = "
		.. nil_to_null(vim.g.terminal_color_3)
		.. "\n\tlet g:terminal_color_4 = "
		.. nil_to_null(vim.g.terminal_color_4)
		.. "\n\tlet g:terminal_color_5 = "
		.. nil_to_null(vim.g.terminal_color_5)
		.. "\n\tlet g:terminal_color_6 = "
		.. nil_to_null(vim.g.terminal_color_6)
		.. "\n\tlet g:terminal_color_7 = "
		.. nil_to_null(vim.g.terminal_color_7)
		.. "\n\tlet g:terminal_color_8 = "
		.. nil_to_null(vim.g.terminal_color_8)
		.. "\n\tlet g:terminal_color_9 = "
		.. nil_to_null(vim.g.terminal_color_9)
		.. "\n\tlet g:terminal_color_10 = "
		.. nil_to_null(vim.g.terminal_color_10)
		.. "\n\tlet g:terminal_color_11 = "
		.. nil_to_null(vim.g.terminal_color_11)
		.. "\n\tlet g:terminal_color_12 = "
		.. nil_to_null(vim.g.terminal_color_12)
		.. "\n\tlet g:terminal_color_13 = "
		.. nil_to_null(vim.g.terminal_color_13)
		.. "\n\tlet g:terminal_color_14 = "
		.. nil_to_null(vim.g.terminal_color_14)
		.. "\n\tlet g:terminal_color_15 = "
		.. nil_to_null(vim.g.terminal_color_15)
end
