...
local function get(bg, get_terminal)
	...
	if bg ~= "light" then
		...
		palette = {
			...
			define = 0x7766FF,
			diff_add = 0x1a4032,
			diff_change = 0x403e1a,
			diff_delete = 0x401a1a,
			diff_syntax_add = 0x22FF22,
			diff_syntax_change = 0xF0DF33,
			diff_syntax_delete = 0xEE4A59,
			enum = 0x7766FF,
			error = 0xEE4A59,
			event = 0x2BFF99,
			field = 0xC0C0C0,
		...
		palette = {
			...
			define = 0x614AE2,
			diff_add = 0x9dc6b5,
			diff_change = 0xbab991,
			diff_delete = 0xf4c0bd,
			diff_syntax_add = 0x007A01,
			diff_syntax_change = 0x706700,
			diff_syntax_delete = 0xB7002F,
			enum = 0x614AE2,
			error = 0xB7002F,
			event = 0x007743,
			field = 0x343434,
