...
--- @alias highlite.groups.from_palette.opts.plugins.nvim 'barbar'|'cmp'|'gitsigns'|'indent_blankline'|'lazy'|'lsp_signature'|'lspconfig'|'lspsaga'|'mini'|'nvim_tree'|'packer'|'symbols_outline'|'todo_comments'|'trouble'
