...
local function from_palette(palette, opts)
	local all_nvim_plugins, any_nvim_plugins, all_syntax, any_syntax, all_vim_plugins, any_vim_plugins =
		Options.parse_from_palette(opts)
	...
	local groups = -- {{{
		{
			...
			["@lsp.typemod.function.builtin"] = "@lsp.typemod.function.defaultLibrary",
			["@lsp.typemod.function.defaultLibrary"] = "@function.builtin",
			["@lsp.typemod.function.readonly"] = "@lsp.type.function",
			["@lsp.typemod.keyword.conditional"] = "@keyword.conditional",
			...
			["@markup.link.label"] = { fg = palette.markup_link_label, nocombine = true },
			["@markup.link.url"] = "@string.special.url",
			["@markup.list"] = { fg = palette.markup_list, nocombine = true },
			["@markup.list.checked"] = { fg = palette.markup_list_checked, nocombine = true },
			["@markup.list.unchecked"] = { fg = palette.markup_list_unchecked, nocombine = true },
			["@markup.math"] = { fg = palette.text_math },
			["@markup.quote"] = { fg = palette.markup_quote },
	...
	if any_nvim_plugins then
		...
		if all_nvim_plugins or nvim_plugins.cmp ~= false then
			...
			groups.CmpItemKindClass = "@lsp.type.class.cmp"
			groups.CmpItemKindColor = "@string.special"
			groups.CmpItemKindConstant = "@constant.cmp"
			groups.CmpItemKindConstructor = "@constructor.cmp"
			groups.CmpItemKindEnum = "@lsp.type.enum.cmp"
			groups.CmpItemKindEnumMember = "@lsp.type.enumMember.cmp"
			groups.CmpItemKindEvent = "@event.cmp"
			groups.CmpItemKindField = "@variable.member"
			groups.CmpItemKindFile = "CmpItemKindFolder"
			groups.CmpItemKindFolder = "@string.special.path.cmp"
			groups.CmpItemKindFunction = "@function.cmp"
			groups.CmpItemKindInterface = "@lsp.type.interface.cmp"
			groups.CmpItemKindKeyword = "@keyword.cmp"
			groups.CmpItemKindMethod = "@function.method.cmp"
			groups.CmpItemKindModule = "@module.cmp"
			groups.CmpItemKindOperator = "@operator.cmp"
			groups.CmpItemKindProperty = "@property.cmp"
			groups.CmpItemKindReference = "@markup.link"
			groups.CmpItemKindSnippet = "@function.macro"
			groups.CmpItemKindStruct = "@structure.cmp"
			groups.CmpItemKindText = "@string.cmp"
			groups.CmpItemKindTypeParameter = "@lsp.type.typeParameter.cmp"
			groups.CmpItemKindUnit = "@type.builtin.cmp"
			groups.CmpItemKindValue = "@constant.builtin.cmp"
