...
local function get(bg, get_terminal)
	...
	if bg ~= "light" then
		...
		palette = {
			...
			diff_delete = 0x514045,
			diff_syntax_add = 0xA7C080,
			diff_syntax_change = 0x7FBBB3,
			diff_syntax_delete = 0xE67E80,
			enum = 0xDBBC7F,
			error = 0xE67E80,
			event = 0xE67E80,
			field = 0x7FBBB3,
			...
			keyword_modifier = 0xE67E80,
			keyword_operator = 0xE69875,
			keyword_return = 0xE67E80,
			keyword_type = 0xE67E80,
			label = 0xE69875,
			loop = 0xE67E80,
			macro = 0x83C092,
			markup_link_label = 0xDBBC7F,
			markup_list = 0x7FBBB3,
			markup_list_checked = 0xA7C080,
			markup_list_unchecked = 0x859289,
			markup_quote = 0x859289,
			message = 0xD3C6AA,
			method = 0xA7C080,
			namespace = 0xDBBC7F,
			namespace_builtin = 0xDBBC7F,
			number = 0xD699B6,
			ok = 0xA7C080,
			operator = 0xE69875,
			parameter = 0xD3C6AA,
			parameter_builtin = 0xD3C6AA,
			preproc = 0xD699B6,
			...
			storage = 0xE69875,
			string = 0x83C092,
			string_documentation = 0x83C092,
			string_escape = 0xA7C080,
			string_regex = 0xA7C080,
			string_special = 0xDBBC7F,
			string_special_symbol = 0xD3C6AA,
			structure = 0xE69875,
			...
			text_environment = 0x83C092,
			text_environment_name = 0xDBBC7F,
		...
		palette = {
			...
			diff_delete = 0xFDE3DA,
			diff_syntax_add = 0x8DA101,
			diff_syntax_change = 0x3A94C5,
			diff_syntax_delete = 0xF85552,
			enum = 0xDFA000,
			error = 0xF85552,
			event = 0xF85552,
			field = 0x3A94C5,
			...
			keyword_modifier = 0xF85552,
			keyword_operator = 0xF57D26,
			keyword_return = 0xF85552,
			keyword_type = 0xF85552,
			label = 0xF57D26,
			loop = 0xF85552,
			macro = 0x35A77C,
			markup_link_label = 0xDFA000,
			markup_list = 0x3A94C5,
			markup_list_checked = 0x8DA101,
			markup_list_unchecked = 0x939F91,
			markup_quote = 0x939F91,
			message = 0x5C6A72,
			method = 0x8DA101,
			namespace = 0xDFA000,
			namespace_builtin = 0xDFA000,
			number = 0xDF69BA,
			ok = 0x8DA101,
			operator = 0xF57D26,
			parameter = 0x5C6A72,
			parameter_builtin = 0x5C6A72,
			preproc = 0xDF69BA,
			...
			storage = 0xF57D26,
			string = 0x35A77C,
			string_documentation = 0x35A77C,
			string_escape = 0x8DA101,
			string_regex = 0x8DA101,
			string_special = 0xDFA000,
			string_special_symbol = 0x5C6A72,
			structure = 0xF57D26,
			...
			text_environment = 0x35A77C,
			text_environment_name = 0xDFA000,
